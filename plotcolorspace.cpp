...
int main(void) {
    ...
    double const min_a = -40;
    double const max_a = 40;
    double const min_b = -40;
    double const max_b = 40;
...
#pragma omp critical
        ...
        std::cout << "a : [" << min_success_a << ", " << max_success_a << "]" << std::endl;
        std::cout << "b : [" << min_success_b << ", " << max_success_b << "]" << std::endl;
    }
